...
export function DashboardShell({children,user,workspace,role}:{children:React.ReactNode;user:{name:string;email:string};workspace:string;role:string}){
